        ...
        <div class="inner_container">
                                ...
                                <body>
                                    <div class="container mt-5">
                                        <div class="d-flex justify-content-between mb-4">
                                            ...
                                            <a href='form_jadwal.php' class="btn btn-success">Tambahkan Jadwal</a>
                                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-warning"
                                                                onclick="showEditForm('<?php echo $dt_jadwal['id_jadwal']; ?>')">Edit</button>
                                                            <button type="button" class="btn btn-danger"
                                                                onclick="confirmDelete('<?php echo $dt_jadwal['id_jadwal']; ?>')">Hapus</button>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
            ...
            <script>
                ...
                function showEditForm(id) {
                    ...
                    window.location.href = "form_jadwal.php?action=edit&id=" + id;
                }
                ...
                function confirmDelete(id) {
                    if (confirm("Apakah Anda yakin ingin menghapus jadwal ini?")) {
                        ...
                        form.setAttribute("action", "aksi_jadwal.php");

                        // Buat input hidden untuk mengirimkan ID wisata
                        var hiddenId = document.createElement("input");
                        hiddenId.setAttribute("type", "hidden");
                        hiddenId.setAttribute("name", "id_jadwal");
