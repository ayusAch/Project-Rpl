        ...
        <div class="inner_container">
                                        ...
                                        <form action="">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $no = 1;
                                                    while ($dt_wisata = $dt_query->fetch_array()) {
                                                        ?>
                                                        <tr>
                                                            <td>
                                                                <?php echo ($no++); ?>
                                                            ...
                                                            <td>
                                                                <?php echo ($dt_wisata['jenis_wisata']); ?>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <button type="button" class="btn btn-warning"
                                                                    onclick="showEditForm('<?php echo $dt_wisata['id_wisata']; ?>')">Edit</button>
                                                                <button type="button" class="btn btn-danger"
                                                                    onclick="confirmDelete('<?php echo $dt_wisata['id_wisata']; ?>')">Hapus</button>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    }
            ...
            <script>
                ...
                function showEditForm(id) {
                    ...
                    window.location.href = "form_wisata.php?action=edit&id=" + id;
                }
                ...
                function confirmDelete(id) {
                    if (confirm("Apakah Anda yakin ingin menghapus data wisata ini?")) {
                        ...
                        form.setAttribute("action", "aksi_wisata.php");

                        // Buat input hidden untuk mengirimkan ID wisata
                        var hiddenId = document.createElement("input");
                        hiddenId.setAttribute("type", "hidden");
                        hiddenId.setAttribute("name", "id_wisata");
