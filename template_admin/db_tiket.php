...
INNER JOIN destinasi ON destinasi.id_destinasi = tiket.id_destinasi
                                    ...
                                    <div class="container mt-5">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                while ($dt_tiket = $dt_query->fetch_assoc()) {
                                                    ?>
                                                    <tr>
                                                        <td>
                                                            <?php echo ($no++); ?>
                                                        ...
                                                        <td>
                                                            <?php echo ($dt_tiket['username']); ?>
                                                        </td>
                                                        <td>
                                                            <?php echo ($dt_tiket['nama_destinasi']); ?>
                                                        </td>
                                                        <td>
                                                            <?php echo ($dt_tiket['jumlah_tiket']); ?>
                                                        </td>
                                                        <td>
                                                            <?php echo ($dt_tiket['total_harga']); ?>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
