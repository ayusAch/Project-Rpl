         ...
         <nav id="sidebar">
            <div class="sidebar_blog_1">
                  ...
                  <div class="user_profle_side">
                     ...
                     <div class="user_info">
                        ...
                        if (isset($_SESSION['username'])) {
                           ...
                           echo '<a class="dropdown-item" href="../pages/aksi/logout.php">Logout</a>';
                           echo '</div>';
                           echo '</div>';
                           echo '<p><span class="online_animation"></span> Online</p>';
                        } else {
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     <li class="active">
                        <a href="#info_pengunjung" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
