...
$query = "SELECT * FROM pesanan INNER JOIN tiket ON tiket.id_tiket=pesanan.id_tiket
                                    ...
                                    <div class="container mt-5">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                while ($dt_pesanan = $dt_query->fetch_assoc()) {
                                                    ?>
                                                    <tr>
                                                        <td>
                                                            <?php echo ($no++); ?>
                                                        ...
                                                        <td>
                                                            <?php echo ($dt_pesanan['username']); ?>
                                                        </td>
                                                        <td>
                                                            <?php echo ($dt_pesanan['kode_pembayaran']); ?>
                                                        </td>
                                                        <td>
                                                            <?php echo ($dt_pesanan['tanggal_pesanan']); ?>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
