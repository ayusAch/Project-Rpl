...
JOIN destinasi ON destinasi.id_destinasi=ulasan.id_destinasi";
        ...
        <div class="inner_container">
                ...
                <div class="sidebar_blog_1">
                    <div class="sidebar-header">
                        <div class="logo_section">
                            <a href="db_admin.php"><img class="logo_icon img-responsive" src="images/logo/logo_icon.png"
                                    alt="#" /></a>
                        </div>
                    </div>
                                    ...
                                    <div class="container mt-5">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                while ($dt_ulasan = $dt_query->fetch_assoc()) {
                                                    ?>
                                                    <tr>
                                                        <td>
                                                            <?php echo $no++; ?>
                                                        ...
                                                        <td>
                                                            <?php echo $dt_ulasan['username']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $dt_ulasan['id_destinasi']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $dt_ulasan['rating']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $dt_ulasan['komentar']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $dt_ulasan['tanggal_ulasan']; ?>
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-warning"
                                                                onclick="showEditForm('<?php echo $dt_ulasan['id_ulasan']; ?>')">Edit</button>
                                                            <button type="button" class="btn btn-danger"
                                                                onclick="confirmDelete('<?php echo $dt_ulasan['id_ulasan']; ?>')">Hapus</button>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
            ...
            <script>
                ...
                function showEditForm(id) {
                    ...
                    window.location.href = "dt_ulasan.php?action=edit&id=" + id;
                }
                ...
                function confirmDelete(id) {
                    if (confirm("Apakah Anda yakin ingin menghapus ulasan ini?")) {
                        ...
                        form.setAttribute("action", "aksi_ulasan.php");

                        // Buat input hidden untuk mengirimkan ID wisata
                        var hiddenId = document.createElement("input");
                        hiddenId.setAttribute("type", "hidden");
                        hiddenId.setAttribute("name", "id_ulasan");
