...
<body>
    <div class="container mt-5">
        <div class="d-flex justify-content-between mb-4">
            ...
            <div>
                <a href='db_jadwal.php' class="btn btn-success">Jadwal</a>
                <a href='dt_lokasi.php' class="btn btn-success">Lokasi</a>
            </div>
        </div>
        ...
        <thead>
            ...
            <tbody>
                <?php
                $no = 1;
                while ($dt_fasilitas = $dt_query->fetch_assoc()) {
                    ?>
                    <tr>
                        <td>
                            <?php echo ($no++); ?>
                        ...
                        <td>
                            <?php echo ($dt_fasilitas['nama_fasilitas']); ?>
                        </td>
                        <td>
                            ...
                            <a href='delete.php?id=<?php echo ($dt_jenis['id_destinasi']); ?>'
                                ...
                                onclick="return confirm('Yakin ingin menghapus ini?')">Delete</a>
                        </td>
                    </tr>
                    <?php
                }
